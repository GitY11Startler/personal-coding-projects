...
bool Ray::IsInShadow(const Vector3& point, const Vector3& lightPos, const std::vector<std::unique_ptr<Shape>>& objects) const {

    Ray shadowRay(point, (lightPos - point).normalize());
